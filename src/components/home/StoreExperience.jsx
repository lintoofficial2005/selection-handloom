...
export const StoreExperience = ({ onNavigate }) => {
  ...
  return (
    <section className="py-12 sm:py-20 bg-[#EDF3ED] border-y border-[#D0DDD1]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#D0DDD1] overflow-hidden shadow-sm grid grid-cols-1 lg:grid-cols-12">
          
          {/* LEFT: STORE SHOWROOM IMAGE */}
          <div className="lg:col-span-6 relative min-h-[260px] sm:min-h-[380px] bg-[#F5EFE6]">
            <SafeImage
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 p-3.5 sm:p-4 rounded-xl bg-white/95 backdrop-blur-md border border-[#D0DDD1] shadow-lg">
              <span className="text-[9px] sm:text-[10px] uppercase tracking-widest text-[#739376] font-bold block">
                Flagship Destination
              </span>
              <span className="font-brand-title text-sm sm:text-base font-bold text-[#1E2A21]">
                Meerut Heritage Showroom
              </span>
              <p className="text-[10px] sm:text-[11px] text-[#555C56]">
          ...
          <div className="lg:col-span-6 p-5 sm:p-8 lg:p-12 flex flex-col justify-between space-y-6">
            ...
            <div className="pt-3 sm:pt-4 flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 bg-[#243528] text-white rounded-xl text-xs uppercase tracking-widest font-semibold hover:bg-[#3D503F] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 bg-[#FAF7F2] border border-[#D0DDD1] text-[#243528] rounded-xl text-xs uppercase tracking-widest font-semibold hover:bg-[#E6EDE6] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
