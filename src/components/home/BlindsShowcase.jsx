    ...
    <section className="py-20 bg-[#EDF3ED] border-y border-[#D0DDD1]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl border border-[#D0DDD1] overflow-hidden shadow-sm grid grid-cols-1 lg:grid-cols-12">
          ...
          {/* RIGHT: TIMBER & MODERN BLIND IMAGE */}
          <div className="lg:col-span-7 relative min-h-[400px] lg:min-h-[550px] bg-[#F5EFE6] order-1 lg:order-2">
            <SafeImage
              src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85"
              alt="Timber Venetian Blinds & Architectural Living Room"
              className="w-full h-full object-cover"
            />
            <div className="absolute top-6 right-6 bg-[#243528]/90 text-[#FAF7F2] text-[10px] uppercase tracking-widest px-3 py-1 rounded-full backdrop-blur-xs font-semibold">
