    ...
    <section className="py-10 sm:py-16 lg:py-20 bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#D0DDD1] overflow-hidden shadow-xs grid grid-cols-1 lg:grid-cols-12">
          ...
          {/* TOP/LEFT: LIFESTYLE CURTAIN INTERIOR IMAGE */}
          <div className="lg:col-span-7 relative min-h-[260px] sm:min-h-[400px] lg:min-h-[550px] bg-[#F5EFE6]">
            <SafeImage
            ...
            />
            <div className="absolute top-4 left-4 sm:top-6 sm:left-6 bg-[#243528]/90 text-[#FAF7F2] text-[9px] sm:text-[10px] uppercase tracking-widest px-3 py-1 rounded-full backdrop-blur-xs font-semibold">
              Curtain Masterhouse
            </div>
          </div>

          {/* BOTTOM/RIGHT: CURTAIN STORY & SPECS */}
          <div className="lg:col-span-5 p-5 sm:p-8 lg:p-12 flex flex-col justify-between space-y-5 sm:space-y-6">
            <div className="space-y-3 sm:space-y-4">
              ...
              <h3 className="font-editorial text-2xl sm:text-4xl font-light text-[#1E2A21] leading-tight text-balance">
                Curtains that Frame <br className="hidden sm:inline" />
              ...
              <div className="space-y-2 sm:space-y-2.5 pt-1 sm:pt-2 text-xs text-[#243528]">
                {[
                  ...
                  'Brass eyelet grommets and motorized track compatibility',
