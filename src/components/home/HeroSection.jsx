...
export const HeroSection = ({ onNavigate }) => {
  return (
    <section className="relative min-h-[82vh] sm:min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#FAF7F2] pb-12 sm:pb-16 pt-4 sm:pt-8">
      
      {/* BACKGROUND EDITORIAL IMAGERY WITH WARM LINEN TONE & PORTRAIT FOCUS */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6 sm:py-12">
        <div className="max-w-2xl space-y-4 sm:space-y-6">
          ...
          {/* MAIN HERO HEADLINE */}
          <div className="space-y-1.5 sm:space-y-2 animate-in fade-in slide-in-from-bottom-3 duration-700 delay-100">
            <span className="font-brand-title text-xs sm:text-base tracking-[0.22em] sm:tracking-[0.25em] uppercase text-[#49634C] font-semibold block">
              SELECTION HANDLOOM
            </span>
            <h1 className="font-editorial text-3xl sm:text-6xl lg:text-7xl font-light text-[#1A1D1A] tracking-tight leading-[1.12] sm:leading-[1.08] text-balance">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-4 pt-2 sm:pt-4 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-300">
            <button
