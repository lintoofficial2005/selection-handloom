...
export const Newsletter = () => {
  ...
  return (
    <section className="py-20 bg-[#243528] text-[#FAF7F2] border-t border-[#3D503F]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        {subscribed ? (
          <div className="p-5 rounded-2xl bg-[#3D503F] border border-[#739376]/50 max-w-md mx-auto flex items-center justify-center gap-3 text-white">
            <CheckCircle2 className="w-5 h-5 text-[#AEC4B0]" />
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3.5 rounded-xl border border-[#739376]/50 bg-[#1E2A21] text-xs text-white placeholder:text-[#FAF7F2]/50 focus:border-[#AEC4B0] outline-none shadow-xs"
            />
            <button
              type="submit"
              className="px-6 py-3.5 bg-[#FAF7F2] text-[#1E2A21] rounded-xl text-xs uppercase tracking-widest font-semibold hover:bg-[#E6EDE6] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm shrink-0"
            >
              <span>Subscribe</span>
