...
export const HeritageIntro = ({ onNavigate }) => {
  return (
    <section className="py-20 bg-[#EAF0EA] border-y border-[#D0DDD1]/60 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-2">
              <span className="h-px w-8 bg-[#5B7A5E]" />
              <span className="text-[11px] uppercase tracking-[0.25em] text-[#5B7A5E] font-semibold">
                ESTD. 1950 — MEERUT, INDIA
              </span>
            </div>

            <h2 className="font-editorial text-3xl sm:text-5xl font-light text-[#1E2A21] leading-tight">
              Rooted in tradition. <br />
              <span className="italic font-normal text-[#49634C]">Chosen for today.</span>
            </h2>

            <p className="font-sans text-sm sm:text-base text-[#3A403B] leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="p-4 rounded-xl bg-white border border-[#D0DDD1] shadow-xs">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl border-4 border-white aspect-4/5 bg-[#FAF7F2]">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/95 backdrop-blur-md border border-[#D0DDD1] shadow-lg flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#243528] text-[#FAF7F2] flex items-center justify-center shrink-0 font-brand-title font-bold text-base">
                  75
                </div>
                <div>
